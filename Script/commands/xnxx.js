...
module.exports.config = {
  name: "xnxx", // আপনি চাইলে নাম পরিবর্তন করতে পারেন
  version: "1.0.0",
  hasPermssion: 0,
  credits: "Belal x Gemini",
  description: "গুগল ড্রাইভ থেকে ১১০টি ভিডিওর কালেকশন",
...
module.exports.run = async ({ api, event }) => {
  ...
  const cachePath = path.join(__dirname, "cache", `video_${senderID}.mp4`);

  // ফাইল থেকে ডিকোড করা ১১০টি ভিডিও লিঙ্কের সম্পূর্ণ লিস্ট
  const links = [
  ...
  api.sendMessage("দারা ভাই, ভিডিওটা নামিয়ে দিচ্ছি... ⏳", threadID, messageID);
  ...
  try {
    ...
    return api.sendMessage({
      body: "🎬 চাঁদের পাহাড় বসকে বলবি না কিন্তু😬😜",
    ...
    console.error(err);
    return api.sendMessage("❌ দুঃখি ভাই, ভিডিওটি নামাতে পারলাম না।", threadID, messageID);
  }
};
